...
namespace BudgetingSavings.API.Services
{
    ...
    {
        Task<Result<List<AccountResponse>>> GetAllAccountsAsync(CancellationToken cancellationToken);
        ...
        Task<Result<List<AccountResponse>>> GetAllAccountsForCustomerAsync(Guid customerId, CancellationToken cancellationToken);
    }
}
